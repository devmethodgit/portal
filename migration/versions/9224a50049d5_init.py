...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("lpus_name", sa.String(length=255)),
        sa.Column("ogrn", sa.String(length=16)),
    ...
    op.create_table(
        "lpus_to_mo",
        sa.Column("lpus_id", sa.String(length=32), nullable=False),
        sa.Column("mo_id", sa.String(length=32)),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=True),
        sa.Column("changed_at", sa.DateTime(timezone=True), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("lpus_id", sa.String(length=32), nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=True),
        sa.Column("changed_at", sa.DateTime(timezone=True), nullable=True),
        sa.ForeignKeyConstraint(
            ["lpus_id"],
